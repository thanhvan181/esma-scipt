    ...
    <div class="col-span-3">
      <div class="mb-4 flex items-center">
        <select name="" id=""
          ...
          <option value="">default soring</option>
      ...
      <div class="grid grid-cols-3 gap-6">
        <div class="group overflow-hidden rounded bg-white shadow">
          <div class="relative">
            <img src="./src/images/bestsellig-furniture-wardrobe.jpg" alt="" class="w-full" />
            <div
          ...
          <div class="pt-4 pb-3 px-4">
            <a href="">
              <h4 class="uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition">Tu quan ao</h4>
            </a>
